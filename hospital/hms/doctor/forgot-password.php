	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html"><h2> HMS |Récupération de mot de passe Docteur</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							<legend>
							Récupération de mot de passe Docteur
							</legend>
							<p>
							Entrez votre Email et votre mot de passe pour récupérer votre mot de passe.<br />
							...
							<div class="form-actions">
								...
								Renetialiser <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
