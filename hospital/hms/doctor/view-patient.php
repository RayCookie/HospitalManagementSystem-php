...
<html lang="en">
	<head>
		<title>Docteur | Gerer Patients</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Docteur | Gerer Patients</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Docteur</span>
...
<td colspan="4" style="font-size:20px;color:blue">
 Informations Patient</td></tr>

    <tr>
    <th scope>Patient Nom</th>
    <td><?php  echo $row['PatientName'];?></td>
    <th scope>Patient Email</th>
    <td><?php  echo $row['PatientEmail'];?></td>
  </tr>
  <tr>
    <th scope>Patient No. Telephone</th>
    <td><?php  echo $row['PatientContno'];?></td>
    <th>Patient Addresse</th>
  ...
  <tr>
    ...
    <th>Antécédents médicaux du patient</th>
    <td><?php  echo $row['PatientMedhis'];?></td>
     <th>Patient Date Crea.</th>
...
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
  ...
  <tr>
    <th>#</th>
<th>Pression artérielle
</th>
<th>Poid</th>
<th>Glycémie</th>
<th>Température corporelle
</th>
<th>Prescription médicale
</th>
<th>Date Visite</th>
</tr>
<?php  
  ...
  <div class="modal-dialog" role="document">
     <div class="modal-content">
      <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Ajouter Historoique Medical</h5>
