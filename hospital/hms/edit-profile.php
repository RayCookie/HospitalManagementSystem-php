...
<html lang="en">
	<head>
		<title>Utilisateur | Modifier Profile</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Utilisateur | Modifier Profile</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Modifier Profile</h5>
												</div>
...
{
?>
<h4>Profile de <?php echo htmlentities($data['fullName']);?></h4>
<p><b>Profile Date Crea.: </b><?php echo htmlentities($data['regDate']);?></p>
<?php if($data['updationDate']){?>
<p><b>Profile Date Derniere Modification: </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
...
<div class="form-group">
					...
					<a href="change-emaild.php">Modifer Email id</a>
														</div>
